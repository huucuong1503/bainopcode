...
uncheck=False
kiemtra=False
model = load_model('/root/lamduoc/keras_model.h5')
        ...
        while True:
            ...
            try:
                ...
                if dem <=7:
                    ...
                    #image1 = load_model('/root/lamduoc/bienbao.png')
                ...
                if 60>=h>=40 and (255 in img4 or 255 in img5) and 60>=w>=40 :
                    if abs(w-h)<=5:
                        #print(h)
                        try:
                            cv2.imwrite('/root/lamduoc/bienbao.png', k[y:y + h, x:x + w, :])
                            image1 = Image.open('/root/lamduoc/bienbao.png')
